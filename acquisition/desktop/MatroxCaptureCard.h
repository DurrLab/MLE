...
public:
	...
	*/
	...
	/*	Start asynchronous frame grabbing and processing.
	*
	...
	*/
	...
	/*	Stop asynchronous frame grabbing.
	*/
	...
	*/
	...
	/*	Write the current frame to memory. When the size of the video equals fpv, close the
